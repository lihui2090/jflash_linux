/********************************************************************************** 
 ...
 4. The array size error is fixed(S3C2440_MAX_CELLS -> S3C2440_MAX_CELL_INDEX+2)
 5. The array was not followed by '\0', which is fixed.
 6. JTAG_ID reading error is fixed.
 7. Support K9S1208 SMD card for the SMDK2440 board.
...
int main(int argc,char *argv[])
{
	...
	printf("\n");
	printf("+------------------------------------+\n");
	printf("|     SEC JTAG FLASH for 2440+        \n");
	printf("|     modified by Quasar 2003.9.22+   \n");
	printf("+------------------------------------+\n");
